...
# -*- coding: utf-8 -*-
# *************************************************************************************
# @file: auto_train_prosody_multi_speaker.py
# @brief: 
# @author: niezhipeng
# @Created on 2018/4/9
# *************************************************************************************
...
class ProsodyTagger(object):
            ...
            for dev_name, dev_reader in zip(self.dev_watchers, self.dev_readers):
                ...
                if len(dev_losses) > self.task_num:
                    ...
                    self.logger.info("| dev_loss: name = %s, loss = %.5f" %
                                     (dev_name, dev_loss))
                    # tf.summary.scalar("dev_%s_loss" % dev_name, dev_loss)
    ...
    def _make_model_env(self):
        ...
        self.logger.info("[INFO] feature_dim =", str(self.feature_dims))
        ...
        # wordvec_path for word embedding inner model
        model_cfg["wordvec_path"] = trans_dict_paths["wordvec_dict"]
        model_name = model_cfg["name"]
        self.model = getattr(prosody_model, model_name)(
            self.feature_dims, self.target_dims, model_cfg)
    ...
    def run_test_summary(self):
        ...
        sentences = [
            [u"<f11> <UNK> <UNK> <UNK>" , u"转 L v I", u"过 R v I", u"脸 S n I", u"问 S v I", u"珠 L n I", u"宝 R n I", u"商 L n I", u"人 R n B3", u"： S w O",
             u"这 L r I", u"些 R r I", u"珠 L n I", u"子 R n I", u"你 S r I", u"从 S p I", u"哪 L r I", u"儿 R r I", u"弄 S v I", u"来 S m I", u"的 S u B3", u"？ S w O", u"<f11> <UNK> <UNK> <UNK>"],
            [u"<gezi> <UNK> <UNK> <UNK>", u"你 S r I", u"从 S p I", u"不 L v I", u"会 R v I", u"听 L n I", u"说 M n I", u"过 R n I", u"我 S r I", u"在 S p I",
             u"组 S n I", u"里 S f I", u"有 S v I",u"不 L v I", u"尊 M v I", u"重 R v I", u"任 L r I", u"何 R r I", u"一 L n I", u"个 M n I", u"人 R n B3", u"。 S w O", u"<gezi> <UNK> <UNK> <UNK>"]
        ]

        labels = [
            [u"T I  I B2 B1 I B1 I B3 O  I B1 I B3 B1 I I B1 I I B3 O T"],
            [u"T B1 I I  B1 I I  B3 I B1 I B2 B1 I I B1 I B1 I I B3 O T"]
        ]
        ...
        for seq_x, seq_y in zip(sentences, labels):
            inputs.append(np.asarray(self.text_processor.encode_seq_feature(
                [x.strip().split() for x in seq_x], embedding=False),
                dtype=np.int32))
        ...
        feed_dict = self.model.make_feed_inputs(np.stack(inputs),
                                                np.asarray(seq_len),
                                                [np.stack(targets)],
                                                dropout=0.,
                                                is_training=False)
...
if __name__ == "__main__":
    ...
    cfg_file = "../conf/prosody_multi_speaker_densely_cnn.json"
    # cfg_file = "../conf/prosody_multi_speaker_CCBBF.json"
    # cfg_file = "../conf/prosody_multi_speaker_id_cnn_3_block.json"
